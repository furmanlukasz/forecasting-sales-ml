...
# forecast_sales_ml documentation build
...
from forecast_sales_ml import __version__ as release

# -- Project information -----------------------------------------------------

project = "forecast_sales_ml"
author = "Kedro"
...
htmlhelp_basename = "forecast_sales_mldoc"
...
latex_documents = [
    (
        master_doc,
        "forecast_sales_ml.tex",
        "forecast_sales_ml Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "forecast_sales_ml",
        "Project forecast_sales_ml codebase.",
        "Data-Science",
    )
]
